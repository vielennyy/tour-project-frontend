...
import { EDBEntity, TBaseFilter, TBasePageEntity, TCustomEntityColumn, TDefaultPageName, TDeleteManyInput, TPagedList, TPagedParams } from '@cromwell/core';
...
export declare type TBaseEntityFilter = TBaseFilter & {
    entityType?: string;
};
export declare type TEntityPageProps<TEntityType extends TBasePageEntity, TFilterType extends TBaseEntityFilter> = {
    /**
