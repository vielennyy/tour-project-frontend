...
export const TourThirdCard = ():JSX.Element => {
  return(
    <Box sx={{
      ...
      <Box>
        <img src={uman} alt='tour' style={{width: '100%', height: '200px', objectFit: 'cover', borderTopLeftRadius: '15px', borderTopRightRadius: '15px'}}/>
      </Box>
      <Box sx={{
        padding: 2
      }}>
