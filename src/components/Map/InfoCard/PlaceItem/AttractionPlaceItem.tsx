...
export const AttractionPlaceItem = (props: Attraction) => {
    ...
    return(
            ...
            borderRadius: '15px'}} alignItems="flex-start">
                ...
                <Box sx={{
                    ...
                    <Button variant="contained" href={`/attractions/${place.id}`} sx={{width: '200px', margin: '20px 0px', textTransform:'none', fontSize:'15px', padding:'5px 10px'}}>Дізнитись більше</Button>
